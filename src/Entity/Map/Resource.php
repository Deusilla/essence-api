...
use App\Repository\Map\ResourceRepository;
...
final class Resource implements DictionaryItemInterface
{
    /**
     * Render group for item.
     */
    public const GROUP_READ_ITEM = 'read:map:resource:item';

    /**
     * Render group for collection.
     */
    public const GROUP_READ_COLLECTION = 'read:map:resource:collection';
